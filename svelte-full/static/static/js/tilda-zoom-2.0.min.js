function t_initZoom() {
    ...
    $('[data-zoomable="yes"]').length && (window.tzoominited = !0, $('[data-zoomable="yes"]:not(.t-slds__thumbs_gallery)').addClass("t-zoomable"), $("body").append('<div class="t-zoomer__wrapper">      <div class="t-zoomer__container">      </div>      <div class="t-zoomer__bg"></div>      <div class="t-zoomer__close">        <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">            <path d="M1.41421 -0.000151038L0 1.41406L21.2132 22.6273L22.6274 21.2131L1.41421 -0.000151038Z" fill="black"/>            <path d="M22.6291 1.41421L21.2148 0L0.00164068 21.2132L1.41585 22.6274L22.6291 1.41421Z" fill="black"/>        </svg>      </div>      <div class="t-zoomer__scale ' + o + '">        <svg class="icon-increase" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">            <path d="M22.832 22L17.8592 17.0273" stroke="black" stroke-width="2" stroke-linecap="square"/>            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.58591 3.7511C0.917768 7.41924 0.917768 13.367 4.58591 17.0352C8.25405 20.7033 14.2019 20.7033 17.87 17.0352C21.5381 13.367 21.5381 7.41924 17.87 3.7511C14.2019 0.0829653 8.25405 0.0829653 4.58591 3.7511Z" stroke="black" stroke-width="2"/>            <path d="M6.25781 10.3931H16.2035" stroke="black" stroke-width="2"/>            <path d="M11.2305 15.3662V5.42053" stroke="black" stroke-width="2"/>        </svg>        <svg class="icon-decrease" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">            <path d="M21.9961 22L17.0233 17.0273" stroke="black" stroke-width="2" stroke-linecap="square"/>            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.74997 3.7511C0.0818308 7.41924 0.0818308 13.367 3.74997 17.0352C7.41811 20.7033 13.3659 20.7033 17.0341 17.0352C20.7022 13.367 20.7022 7.41924 17.0341 3.7511C13.3659 0.0829653 7.41811 0.0829653 3.74997 3.7511Z" stroke="black" stroke-width="2"/>            <path d="M5.41797 10.3931H15.3637" stroke="black" stroke-width="2"/>        </svg>      </div>    </div>'), t_showZoom(), $(".t-zoomer__close, .t-zoomer__bg").click(function() {
        t_zoom_unscale(), $(".t-zoomer__scale").unbind(), $("body").removeClass("t-zoomer__show"), $("body").removeClass("t-zoomer__show_fixed"), $(".t-zoomer__wrapper .t-zoomer__scale").css("display", "none"), $(document).unbind("keydown");
        var o = 0 != $(document).find(".t-popup_show").length;
        o && $(document).keydown(function(o) {
...
function t_zoomHandler() {
    ...
    if ($("#" + o).find(".t-slds").length) {
        var t = $(this).closest(".t-slds");
        t.length && (e = t.find(".t-zoomable:not(.t-slds__thumbs_gallery)"))
    }
    e.each(function() {
        var o, e, t, s, _ = $(this).attr("data-img-zoom-url").split(",");
    ...
    var s = $(".t-carousel__zoomer__item");
    s.each(function() {
        ...
        var s = o.innerHeight();
        $(this).css("display", "");
        var _ = $(this).find(".t-carousel__zoomer__wrapper");
        _.css("bottom", s)
    });
    var _ = $(this).attr("data-img-zoom-url"),
        r = $('.t-carousel__zoomer__img[src="' + _ + '"]'),
        i = $(".t-carousel__zoomer__item"),
        a = r.closest(i);
    a.show(0).addClass("active"), i.each(function() {
        $(this).attr("data-zoomer-slide-number", $(this).index())
    });
    var l = parseFloat($(".t-carousel__zoomer__item:visible").attr("data-zoomer-slide-number"));
    $(".t-carousel__zoomer__control_right").click(function() {
        t_zoom_unscale(), $(".t-zoomer__scale").unbind(), $(".t-zoomer__wrapper .t-zoomer__scale").css("display", "none"), l = (l + 1) % i.length, i.hide(0).removeClass("active").eq(l).show(0).addClass("active"), t_zoom_checkForScale()
    }), $(".t-carousel__zoomer__control_left").click(function() {
        t_zoom_unscale(), $(".t-zoomer__scale").unbind(), $(".t-zoomer__wrapper .t-zoomer__scale").css("display", "none"), l = (l - 1) % i.length, i.hide(0).removeClass("active").eq(l).show(0).addClass("active"), t_zoom_checkForScale()
    }), $(document).keydown(function(o) {
        if (37 == o.keyCode && (t_zoom_unscale(), $(".t-zoomer__scale").unbind(), $(".t-zoomer__wrapper .t-zoomer__scale").css("display", "none"), l = (l - 1) % i.length, i.hide(0).removeClass("active").eq(l).show(0).addClass("active"), t_zoom_checkForScale()), 39 == o.keyCode && (t_zoom_unscale(), $(".t-zoomer__scale").unbind(), $(".t-zoomer__wrapper .t-zoomer__scale").css("display", "none"), l = (l + 1) % i.length, i.hide(0).removeClass("active").eq(l).show(0).addClass("active"), t_zoom_checkForScale()), 27 == o.keyCode) {
            $("body").removeClass("t-zoomer__show"), $("body").removeClass("t-zoomer__show_fixed"), $(".t-zoomer__scale").unbind(), t_zoom_unscale(), $(".t-zoomer__wrapper .t-zoomer__scale").css("display", "none"), $(document).unbind("keydown");
            var e = 0 != $(document).find(".t-popup_show").length;
            e && $(document).keydown(function(o) {
                27 == o.keyCode && ($(".t-zoomer__wrapper .t-zoomer__scale").css("display", "none"), t_store_closePopup(!1))
            })
        }
    });
    var c = $(".t-carousel__zoomer__item").size();
    c > 1 ? $("body").addClass("t-zoomer__show_fixed") : $(".t-carousel__zoomer__control").css("display", "none"), $(".t-carousel__zoomer__inner").click(function() {
    ...
    $(window).scroll(function() {
        ...
        o > d && ($("body").not(".t-zoomer__show_fixed").removeClass("t-zoomer__show"), $(document).unbind("keydown")), d = o
...
function t_zoom_checkForScale() {
    ...
    if (e.length) return e.load(function() {
    ...
    }), e[0].complete && !o && (o = !0, $(window).width() < e[0].naturalWidth || $(window).height() < e[0].naturalHeight) ? ($(".t-zoomer__wrapper .t-zoomer__scale").css("display", "block"), void t_zoom_scale_init()) : void 0
}
...
function t_zoom_scale_init() {
    $(".t-zoomer__scale").click(function(o) {
        ...
        if (t.hasClass("scale-active")) t_zoom_unscale();
            ...
            var _ = [];
            if ($(window).width() < e[0].naturalWidth && _.push("x"), $(window).height() < e[0].naturalHeight && _.push("y"), _ = _.join(""), 0 === _.length) return;
            t.addClass("scale-active"), s.addClass("scale-active");
            var r, i, a, l, c = ($(window).width() - e.width()) / 2,
            ...
            switch (e.css("left", c), e.css("top", d), _) {
                case "x":
                    ...
                    break;
                case "y":
                    r = 100 * o.clientY / $(window).height(), i = -r * (e.height() - $(window).height()) / 100, e.css("top", i + "px"), e.mousemove(function(o) {
                        r = 100 * o.clientY / $(window).height(), i = -r * (e.height() - $(window).height()) / 100, e.css("top", i + "px")
                    });
                    break;
                case "xy":
                    r = 100 * o.clientY / $(window).height(), i = -r * (e.height() - $(window).height()) / 100, a = 100 * o.clientX / $(window).width(), l = -a * (e.width() - $(window).width()) / 100, e.css("top", i + "px"), e.css("left", l + "px"), e.mousemove(function(o) {
                        r = 100 * o.clientY / $(window).height(), i = -r * (e.height() - $(window).height()) / 100, a = 100 * o.clientX / $(window).width(), l = -a * (e.width() - $(window).width()) / 100, e.css("top", i + "px"), e.css("left", l + "px")
                    })
            }
        }
    })
