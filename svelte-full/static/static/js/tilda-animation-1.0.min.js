...
function t_animate__parseNumberText(t) {
    ...
    t.each(function() {
        ...
        if (!($(this).offset().top < a - 500) && e.length > 0) {
            var s = e.replace(/[^\d\.\,\ ]+/g, "").match(/\d+\.\d+|\d+\,\d+/g),
                r = e.replace(/[^\d\.\,\ ]+/g, "").replace(/(\d)(?= \d) /g, "$1"),
                o = [],
                m = r.split(" ");
            m.forEach(function(t, a) {
                isNaN(parseInt(t.replace(/[^\d\.\,\ ]+/g, ""))) || o.push(t.replace(/[^\d\.\,\ ]+/g, ""))
            }), o.forEach(function(t) {
                var a = r.indexOf(t),
                    e = r.substr(a, t.length);
                r = r.replace(e, "num")
            }), o && (o.forEach(function(t, a) {
                var e;
                if (null !== s && (-1 !== t.indexOf(",") && (e = t.split(",")), -1 !== t.indexOf(".") && (e = t.split(".")), -1 !== t.indexOf(",") || -1 !== t.indexOf("."))) {
                    var n = e[1].length;
                    o[a] = +e.join("."), o[a] = o[a].toFixed(n)
                }
            }), t.attr("data-animate-number-count", e), o.forEach(function() {
                t_animate__changeNumberOnZero(t, r)
        ...
        if (t.find("span:not(.t-animate__number):first").each(function() {
            ...
            t.find(".t-animate__number").each(function() {
                ...
                $({
                    ...
                    easing: "swing",
                    step: function(a) {
                        var e = t.find(".t-animate__number")[s],
                            n = Math.pow(10, m),
                            r = a ? (Math.round(this.animateCounter * n) / n).toFixed(m) + "" : Math.floor(this.animateCounter) + "";
                        r = i.length > 1 ? r.replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ") : r, _ ? $(e).text(r.replace(/\./g, ",")) : $(e).text(r)
                    },
                    complete: function() {
