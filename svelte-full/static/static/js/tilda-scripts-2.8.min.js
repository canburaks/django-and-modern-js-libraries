...
window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang,
    ...
    function(e) {
        ...
        function i(t) {
            ...
            if (o) {
                var i = o.querySelector(".t-cover__carrier"),
                    ...
                    s = window.isMobile || /Macintosh/.test(navigator.userAgent) && "ontouchend" in document;
                return !(s || !c || r || n || a || !i || "fixed" != i.dataset.contentCoverParallax || window["cover" + t + "fixbackgroundstyles"])
            }
        }
        ...
        t.prototype.defaultConfig = {
            ...
            for (var t, o, i, r, n = e.items, a = null, c = 0, s = n.length; c < s; c++)
                if (t = n[c].node, t.querySelector(".txt-holder"), r = t.getBoundingClientRect(), r.top < this.itemTransitionTop && r.bottom < r.height + this.itemTransitionTop && r.bottom > this.itemTransitionTop) {
                    a = c;
                    break
                }
            if (null != a) {
    ...
    function(e) {
        e(document).ready(function() {
            if (0 == window.isMobile && "yes" !== e("#allrecords").attr("data-blocks-animationoff") && 0 == window.isSearchBot) {
                ...
                function i() {
                    if (t.length)
                        for (var i, r, n, a = t.length - 1; a >= 0; a--) i = e(t[a]), r = i.offset().top, n = i.outerHeight() <= 100 ? o.scrollTop() + o.height() : o.scrollTop() + o.height() - 100, r < n && (i.removeClass("r_hidden"), i.addClass("r_showed"), t.splice(a, 1))
                }
                t.each(function(t) {
    ...
    function(e) {
        ...
        e.fn.videoBG = function(o, i) {
            ...
            if (r.length) {
                ...
                return i.scale && n.height(i.height).width(i.width), r.append(n), void 0 === r.attr("data-content-video-nomute") && r.find("video").prop("muted", !0), t(n, i.height), n.find("video")[0]
            }
    ...
    function(e) {
        Tilda.sendEcommerceEvent = function(t, o) {
            ...
            d = !(!d || "nosend" != d);
            var l = "";
            if (l = e("#allrecords").data("tilda-currency") || e(".t706").data("project-currency-code") || "RUB", i || (i = window.location.href), r = r ? parseFloat(r) : 0, r > 0)
            ...
            if (window.mainMetrikaId && window.mainMetrikaId > 0 && "function" == typeof ym)
                if (n) {
                    ...
                    r > 0 ? (u.params = {
                        order_price: r
                    }, l && (u.params.currency = l), ym(window.mainMetrikaId, "hit", t, u)) : ym(window.mainMetrikaId, "hit", t, u)
                } else r > 0 ? (u = {
                    order_price: r
                }, l && (u.currency = l), ym(window.mainMetrikaId, "reachGoal", t, u)) : ym(window.mainMetrikaId, "reachGoal", t);
            ...
            if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && 0 == d) try {
                if (n) {
                    ...
                    else if (-1 != t.indexOf("tilda/") && -1 != t.indexOf("/payment/")) {
            ...
            e(".r").off("click", "a.js-click-stat"), e(".r").on("click", "a.js-click-stat", function(t) {
                ...
                if (o || (o = "/tilda/click/".$(this).closest(".r").attr("id") + "/?url=" + r), Tilda.sendEventToStatistics(o, i), "http" == r.substring(0, 4)) return window.setTimeout(function() {
                    var t, o, i = "",
                        a = "";
                    if ("_blank" == n) {
                        if (-1 != r.indexOf("?") && (i = r.split("?"), r = i[0], i = i[1], -1 != i.indexOf("#") && (i = i.split("#"), r = r + "#" + i[1], i = i[0]), i = i.split("&")), 0 == e("#tildaredirectform").length ? e("body").append('<form id="tildaredirectform" target="_blank" method="GET" action="' + r + '" style="display:none;"></form>') : e("#tildaredirectform").attr("method", "GET").attr("action", r), a = "", i.length > 0)
                            for (t in i) o = i[t].split("="), o && o.length > 0 && (a += '<input type="hidden" name="' + o[0] + '" value="' + (o[1] ? o[1] : "") + '">');
    ...
    function(e) {
        e(document).ready(function() {
            setTimeout(function() {
                0 === e("#tildacopy").length ? e("body").contents().filter(function() {
                ...
                }) : e("body").height() + 70 < e(window).height() || e(".t-tildalabel").attr("style", "display: block !important")
            }, 500)
        })
    }(jQuery);